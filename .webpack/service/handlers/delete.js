...
async function main(event, context) {
	...
	try {
		const result = await _libs_dynamodb_lib__WEBPACK_IMPORTED_MODULE_1__["call"]("delete", params);
		return Object(_libs_response_lib__WEBPACK_IMPORTED_MODULE_2__["success"])({ status: true });
	} catch (e) {
		return Object(_libs_response_lib__WEBPACK_IMPORTED_MODULE_2__["failure"])({ status: false });
	}
}
...
function buildResponse(statusCode, body) {
	return {
		...
		body: babel_runtime_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(body)
	};
}
